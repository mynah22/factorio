...
6. Dynamic routes should have a 'depot' station, for both refueling and having somewhere to go if all pickups / drops are full.
    ...
    - I build my depots much like a stacker, but with stations (named "[locomotive icon] depot") on each stacker, room for refuling infrastructure, and no chain signals.
